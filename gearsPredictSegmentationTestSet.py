#Predict masks for test set and save to file.
...
#measure gears
path = Path("./Gear/Synthetic Images/11/normal").rglob("*.png")#use the last folder for test dataset
...
for img_path in path:
    ...
    img2[:,:,2] = output
    output=img2
    cv2.imwrite("./GearsTestSetOutput/"+img_path.name,output)